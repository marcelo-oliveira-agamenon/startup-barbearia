...
export class Sale1615137125735 implements MigrationInterface {
  name = 'Sale1615137125735';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "sale" ("sale_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "discount" numeric(10,2) NOT NULL DEFAULT '0', "is_discount_fixed" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "clientClientId" uuid, "userUserId" uuid, CONSTRAINT "PK_1f5c38463e847a2a0e74cf8035a" PRIMARY KEY ("sale_id"))`
    );
    await queryRunner.query(
